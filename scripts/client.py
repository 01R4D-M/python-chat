...
tkinter.Entry(hostinfo, textvariable=ip).pack()
tkinter.Label(hostinfo, text="Ingrese el puerto del host:").pack()
tkinter.Entry(hostinfo, textvariable=puerto).pack()
...
class Client:
    def __init__(self, host, port):
        ...
        self.nickname = simpledialog.askstring("Nombre", "Escriba su nombre", parent=msg)
